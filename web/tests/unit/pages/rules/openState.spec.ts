          ...
          section: [
            {
              ...
              title: '時間の計り方',
              content: '合図から始める',
              lines: [{ depth: 0, label: '', text: '合図から始める', bullet: false }],
              block: [],
              image: [],
            },
            {
              ...
              block: [
                {
                  ...
                  title: '2秒まで',
                  element: '0.05 の減点',
                  lines: [{ depth: 0, label: '', text: '0.05 の減点', bullet: false }],
                  image: [],
                },
                {
                  number: '1.1.2.2',
                  title: '2秒を超える',
                  element: '0.10 の減点',
                  lines: [{ depth: 0, label: '', text: '0.10 の減点', bullet: false }],
                  image: [],
                },
              ],
            },
          ...
          section: [
            {
              ...
              title: 'スティックの長さ',
              content: '45cm 以上',
              lines: [{ depth: 0, label: '', text: '45cm 以上', bullet: false }],
              block: [],
              image: [],
            },
          ],
          ...
          section: [
            {
              ...
              title: '人数',
              content: '実施は 4 名',
              lines: [{ depth: 0, label: '', text: '実施は 4 名', bullet: false }],
              block: [],
              image: [],
            },
          ],
