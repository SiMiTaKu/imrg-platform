...
export const EVENTS: CalendarEvent[] = [
  ...
  },
  {
    ...
    note: { ja: "クラブチームと社会人の全国大会です。「2026新体操フェスタ岐阜」の一つとして、岐阜メモリアルセンター で愛ドームで開かれます。", en: "National championships for club teams and adult gymnasts, held as part of the 2026 Rhythmic Gymnastics Festa Gifu at the Gifu Memorial Center Deai Dome." },
  ...
  },
  {
    ...
    endDate: "2026-10-12",
    venue: { name: { ja: "NOPPOROヤシマ商会スポーツパーク（北海道）", en: "NOPPORO Yashima Shokai Sports Park" } },
    note: { ja: "北海道のジュニア選手の大会です。北海道体操協会が10月11日と12日に開きます。", en: "A junior competition in Hokkaido, held by the Hokkaido Gymnastics Association on October 11 and 12." },
  ...
  },
  {
    ...
    endDate: "2026-11-01",
    venue: { name: { ja: "高崎アリーナ（群馬県）", en: "Takasaki Arena" } },
    note: { ja: "日本一を決める大会です。男子は個人競技と団体競技を行います。10月30日から11月1日まで、高崎アリーナ（群馬県）で女子と同じ会場で開かれます。", en: "The national championships that decide Japan's best. The men's competition includes both individual and group events. Held at Takasaki Arena in Gunma from October 30 to November 1, at the same venue as the women's competition." },
  ...
  },
  {
    ...
    note: { ja: "全国高等学校選抜大会の東北予選にあたる大会です。岩手県北上市のトヨタ紡織東北サンシャインアリーナで開かれます。", en: "The Tohoku qualifier for the National High School Invitational. Held at Toyota Boshoku Tohoku Sunshine Arena in Kitakami, Iwate." },
  ...
  },
  {
    ...
    venue: { name: { ja: "高崎アリーナ（群馬県）", en: "Takasaki Arena" } },
    note: { ja: "翌日から同じ高崎アリーナで開かれる全日本ジュニア選手権の前に行われる、男女共催の大会です。", en: "Held the day before the All Japan Junior Championships begin at the same venue, Takasaki Arena. Men's and women's events are held together." },
  ...
  },
  {
    ...
    endDate: "2026-11-29",
    venue: { name: { ja: "高崎アリーナ（群馬県）", en: "Takasaki Arena" } },
    note: { ja: "ジュニアの日本一を決める大会です。男子は11月27日に個人（スティック・リング）、28日に個人（ロープ・クラブ）、29日に団体（徒手）を行います。高崎アリーナ（群馬県）で女子と同じ会場で開かれます。", en: "The national junior championships. The men's schedule is individual (sticks and ring) on November 27, individual (rope and clubs) on the 28th, and group Toshu (floor routine, no apparatus) on the 29th. Held at Takasaki Arena in Gunma, at the same venue as the women's competition." },
  ...
  },
  {
    ...
    note: { ja: "高校生の全国大会です。2027年に宮崎で開かれる国民スポーツ大会のリハーサル大会として、延岡市のアスリートタウン延岡アリーナで行われます。男女共催です。", en: "The national high school invitational. Held at Athlete Town Nobeoka Arena in Nobeoka, Miyazaki as a rehearsal event for the 2027 national sports games, with men's and women's events together." },
  ...
  },
  {
    ...
    endDate: "2027-07-25",
    venue: { name: { ja: "千葉ポートアリーナ（千葉県）", en: "Chiba Port Arena" } },
    note: { ja: "高校総体（インターハイ）の新体操競技です。千葉市の千葉ポートアリーナで、男女共催で開かれます。総合開会式は7月22日に横浜BUNTAIで行われます。", en: "The rhythmic gymnastics events of the National High School Championships (Inter-High). Held at Chiba Port Arena in Chiba City, with men's and women's events together. The overall opening ceremony is on July 22 at Yokohama BUNTAI." },
