...
export const VIDEOS: readonly VideoResource[] = [
  ...Object.values(INDIVIDUAL_VIDEOS),
  ...Object.values(GROUP_VIDEOS),
]

/** おすすめ動画。サーバーで書き出す HTML はこの並びになる（ブラウザーで並べ替える） */
export const RECOMMENDED_VIDEOS: readonly VideoResource[] = [
