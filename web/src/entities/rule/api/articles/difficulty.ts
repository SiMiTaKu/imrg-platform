...
跳躍・バランス・倒立（静止2秒）・柔軟A〜静的柔軟〜を以下に示す`,
              english: `Free-hand difficulties are determined as follows.
            ...
            image: [
              {
                ...
                alt: {
                  japanese: '徒手系難度（跳躍）',
                  english: 'Free-hand difficulties (jumps)',
                },
              },
              {
                ...
                alt: {
                  japanese: '徒手系難度（バランス）',
                  english: 'Free-hand difficulties (balances)',
                },
              },
              {
                ...
                alt: {
                  japanese: '倒立（静止２秒',
                  english: 'Handstands (held for 2 seconds)',
                },
              },
              {
                ...
                alt: {
                  japanese: '柔軟Ａ　〜静的柔軟〜',
                  english: 'Flexibility A (static flexibility)',
                },
              },
            ],
          },
        ...
        block: [
          {
            ...
            element: {
              japanese: `転回系の難度は次の基礎難度をもとに価値が決められる。
...
後方伸身宙返りにひねりが加わった場合も同等の扱いとする。`,
              english: `The value of tumbling difficulties is determined from the following basic difficulties.
...
A layout back salto with an added twist is also treated in the same way.`,
            ...
            image: [
              {
                ...
                alt: {
                  japanese: 'とびひねり技の難度表',
                  english: 'Table of twisting element difficulties',
                },
              },
              {
                ...
                alt: {
                  japanese: '前方系跳躍技の難度表',
                  english: 'Table of forward tumbling difficulties',
                },
              },
              {
                src: '/images/rules/backwardjumpdifficulties.png',
                alt: {
                  japanese: '後方系の跳躍技の難度表',
                  english: 'Table of backward tumbling difficulties',
                },
              },
              {
                ...
                alt: {
                  japanese: '宙返りの連続の難度表',
                  english: 'Table of salto combination difficulties',
                },
              },
              {
                ...
                alt: {
                  japanese: '転回系の連続の難度表',
                  english: 'Table of tumbling combination difficulties',
                },
              },
            ],
          },
      ...
      {
        title: {
          japanese: '団体競技における難度の組み合わせ',
          english: 'Difficulty Combinations in the Group Competition',
        },
        block: [
          {
            title: {
              japanese: '交差技と組運動の難度',
              english: 'Difficulty of Crossing Elements and Partner Elements',
            },
            element: {
              japanese: `【交差技】
交差技の難度は以下の通りとする。
...
3. When groups perform tumbling of the same difficulty
  ...
  3. If every difficulty is performed by fewer than three gymnasts, even after counting higher difficulties as lower ones, no difficulty is recognized.`,
      ...
      },
      {
        title: {
          japanese: '個人競技における難度',
          english: 'Difficulty in the Individual Competition',
        },
        block: [
          {
            title: {
              japanese: '転回系における手具操作と難度',
              english: 'Apparatus Handling and Difficulty in Tumbling',
            },
            element: {
              japanese: `演技の中で転回系を実施した場合の難度は、基礎難度表によって価値が決められる。ただし、以下の条件に当てはまる場合は、その難度から１ランクアップされる。
...
2. ２回以上の手具操作をともなって、実施した場合。
  ...
  e. その他の手具操作
    ...
    ⅱ. 転回系を実施している間に手具を転がして、着地と同時にとる。`,
              english: `The difficulty of tumbling performed in a routine is determined by the table of basic difficulties. However, it rises one rank in the following cases.
  ...
  e. Other apparatus handling
    ...
    ii. Rolling the apparatus during tumbling and catching it on landing.`,
          ...
          },
          {
            title: {
              japanese: '投げ受けの難度',
              english: 'Throw-and-Catch Difficulty',
            },
            element: {
              japanese: `演技の中で投げ受けを実施した場合、その間に実施した徒手系（※）または転回系の数によって以下のように難度が決められる。ただし、転回系が含まれていた場合は第69条の１の条件と比較して、高い方の難度を採用する。
※ここでの徒手系は、縦軸または横軸で、360°回転したもののみを１つとして数える。`,
              english: `When a throw and catch is performed in a routine, the difficulty is determined as follows by the number of free-hand elements (*) or tumbling elements performed during the throw. If tumbling is included, the difficulty is compared with the condition in Article 69 (1), and the higher one applies.
* Here, a free-hand element counts as one only when it is a 360° rotation around the vertical or horizontal axis.`,
            ...
            image: [
              {
                ...
                alt: {
                  japanese: '投げ受けの難度表',
                  english: 'Table of throw-and-catch difficulties',
                },
              },
            ],
          },
          {
            title: {
              japanese: '手具操作をともなった徒手系の難度',
              english: 'Difficulty of Free-Hand Elements with Apparatus Handling',
            },
            element: {
              japanese:
