...
export const COMPETITION_ORGANIZATION_ARTICLES: RuleArticle[] = [
    ...
    section: [
      {
        title: {
          japanese: '本規則の指針',
          english: 'Purpose of These Rules',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '本規則の改正',
          english: 'Amendment of These Rules',
        },
        content: {
          japanese: '本規則の改正は、男子新体操委員会で過半数を持って議決する。',
          english:
  ...
  {
    title: {
      japanese: '協議会及び各種大会の組織',
      english: 'Organization of Competitions',
    },
    section: [
      {
        title: {
          japanese: '各種大会',
          english: 'Types of Competitions',
        },
        content: {
          japanese: `【全日本選手権大会】
...
【国際競技大会】
  ...
  その競技組織・運営の具体的計画は、ＦＩＧ諸規則に基づき男子新体操委員会で起案資本協会理事会の承認を受ける。`,
          english: `[All Japan Championships]
...
[International Competitions]
  ...
  {
    title: {
      japanese: '協議会及び各種大会の運営',
      english: 'Running Competitions',
    },
    section: [
      {
        title: {
          japanese: '組織協会の責任',
          english: 'Responsibilities of the Organizing Association',
        },
        content: {
          japanese: `組織協会はその構成する組織委員会においても全責任をもつ。組織協会は宣伝および組織の全経費を負担する。その中に以下のものを含む。
...
7. 計算作業、競技会経過中の成績および決定成績の公表、報道機関用書類の作成。組織委員会は、審判に必要な情報を提供し、業務を援助する。一般に組織委員会は、男子新体操委員会と連絡を密にし、必要な事項を処理する`,
          english: `The organizing association bears full responsibility, including for the Organizing Committee it forms. It bears all costs of publicity and organization, including the following.
...
7. Calculating results, announcing results during the competition and the final results, and preparing documents for the press. The Organizing Committee provides the judges with the information they need and supports their work. In general, the Organizing Committee keeps in close contact with the Men's Rhythmic Gymnastics Committee and handles the necessary matters.`,
      ...
      },
      {
        ...
        content: {
          japanese: `出場申し込みは、所定の時期に本協会事務局から、各加盟団体に送付する様式、またはホームページに掲載された様式による
...
`,
          english: `Entries are made on the form that the Association's secretariat sends to each member organization at the specified time, or on the form posted on the website.
...
3. If a gymnast needs to be changed after the entry has been submitted, the change must be submitted in writing to the Organizing Committee by the day before the competition and confirmed at the team managers' meeting. After the team managers' meeting, only gymnasts who were entered may be substituted.`,
      ...
      },
      {
        title: {
          japanese: '規定演技の作成',
          english: 'Creation of Compulsory Routines',
        },
        content: {
          japanese:
      ...
      {
        title: {
          japanese: '競技規則及び採点規則に定めない事項',
          english: 'Matters Not Covered by the Competition Rules or the Code of Points',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '審判団の選定',
          english: 'Selection of the Judging Panel',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '競技部長の任命',
          english: 'Appointment of the Competition Director',
        },
        content: {
          japanese:
      ...
      {
        title: {
          japanese: '審判団・競技部長・会場係長の責務',
          english: 'Duties of the Judging Panel, the Competition Director and the Venue Manager',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '裁定審判部の設置',
          english: 'Establishment of the Appeals Jury',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '裁定審判部の裁決',
          english: 'Decisions of the Appeals Jury',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '決定点の公開',
          english: 'Display of Final Scores',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '音響設備の準備',
          english: 'Preparation of Audio Equipment',
        },
        content: {
          japanese: '組織委員会は伴奏音楽を使用するための音響機器を準備しなければならない。',
          english:
      ...
      {
        title: {
          japanese: '審判会議および監督会議の開催',
          english: "Judges' Meeting and Team Managers' Meeting",
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '採点表の写しと全記録',
          english: 'Copies of Score Sheets and Complete Records',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '競技会場と演技面',
          english: 'Competition Hall and Floor Area',
        },
        content: {
          japanese:
      ...
      },
      {
        title: {
          japanese: '器械器具の準備',
          english: 'Preparation of Equipment',
        },
        content: {
          japanese:
