...
3. आवेदन प्रस्तुत करने के बाद जिम्नास्ट बदलने की आवश्यकता होने पर, प्रतियोगिता से एक दिन पहले तक लिखित रूप में आयोजन समिति को प्रस्तुत करना होगा और कोच बैठक में उसकी पुष्टि की जाएगी। परंतु कोच बैठक के बाद, केवल आवेदन किए गए जिम्नास्ट ही बदले जा सकते हैं`,
      ...
      },
      {
        ...
        content: {
          ...
          ko: '부 깃발(클럽 깃발)은 1장을 한도로 하고, 크기는 4m<sup>2</sup> 이내로 한다. 다만 게시하는 장소는 조직 위원회가 지정하는 곳으로 한다.',
          es: 'Se admite una sola bandera de sección (bandera de club), de un tamaño máximo de 4 m<sup>2</sup>. El lugar en el que se coloque será el que designe el comité organizador.',
          ...
          ru: 'Команда может вывесить не более одного командного (клубного) флага площадью не более 4 м<sup>2</sup>. Место его размещения определяет оргкомитет.',
          hi: 'टीम का झंडा (क्लब झंडा) अधिकतम 1 ही होगा, और उसका आकार 4m<sup>2</sup> के भीतर होगा। परंतु उसे लगाने का स्थान आयोजन समिति द्वारा निर्धारित स्थान होगा।',
        },
      },
      {
        title: {
