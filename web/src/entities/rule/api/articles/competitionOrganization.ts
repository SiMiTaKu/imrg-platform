...
export const COMPETITION_ORGANIZATION_ARTICLES: RuleArticle[] = [
  {
    ...
    section: [
      {
        title: '本規則の指針',
        titleEn: 'Purpose of These Rules',
        content:
      ...
      {
        title: '本規則の改正',
        titleEn: 'Amendment of These Rules',
  ...
  {
    title: '協議会及び各種大会の組織',
    titleEn: 'Organization of Competitions',
    section: [
      {
        title: '各種大会',
        titleEn: 'Types of Competitions',
        content: `【全日本選手権大会】
...
【国際競技大会】
  ...
  その競技組織・運営の具体的計画は、ＦＩＧ諸規則に基づき男子新体操委員会で起案資本協会理事会の承認を受ける。`,
        contentEn: `[All Japan Championships]
...
[International Competitions]
  ...
  {
    title: '協議会及び各種大会の運営',
    titleEn: 'Running Competitions',
    section: [
      {
        title: '組織協会の責任',
        titleEn: 'Responsibilities of the Organizing Association',
...
7. 計算作業、競技会経過中の成績および決定成績の公表、報道機関用書類の作成。組織委員会は、審判に必要な情報を提供し、業務を援助する。一般に組織委員会は、男子新体操委員会と連絡を密にし、必要な事項を処理する`,
        contentEn: `The organizing association bears full responsibility, including for the Organizing Committee it forms. It bears all costs of publicity and organization, including the following.
...
`,
        contentEn: `Entries are made on the form that the Association's secretariat sends to each member organization at the specified time, or on the form posted on the website.
...
3. If a gymnast needs to be changed after the entry has been submitted, the change must be submitted in writing to the Organizing Committee by the day before the competition and confirmed at the team managers' meeting. After the team managers' meeting, only gymnasts who were entered may be substituted.`,
      ...
      {
        title: '規定演技の作成',
        titleEn: 'Creation of Compulsory Routines',
        content:
      ...
      },
      {
        ...
        titleEn: 'Matters Not Covered by the Competition Rules or the Code of Points',
        content:
      ...
      {
        title: '審判団の選定',
        titleEn: 'Selection of the Judging Panel',
        content:
      ...
      {
        title: '競技部長の任命',
        titleEn: 'Appointment of the Competition Director',
        content:
      ...
      },
      {
        ...
        titleEn: 'Duties of the Judging Panel, the Competition Director and the Venue Manager',
        content:
      ...
      {
        title: '裁定審判部の設置',
        titleEn: 'Establishment of the Appeals Jury',
        content:
      ...
      {
        title: '裁定審判部の裁決',
        titleEn: 'Decisions of the Appeals Jury',
        content:
      ...
      {
        title: '決定点の公開',
        titleEn: 'Display of Final Scores',
        content:
      ...
      {
        title: '音響設備の準備',
        titleEn: 'Preparation of Audio Equipment',
      ...
      },
      {
        ...
        titleEn: "Judges' Meeting and Team Managers' Meeting",
        content:
      ...
      {
        title: '採点表の写しと全記録',
        titleEn: 'Copies of Score Sheets and Complete Records',
        content:
      ...
      {
        title: '競技会場と演技面',
        titleEn: 'Competition Hall and Floor Area',
        content:
      ...
      {
        title: '器械器具の準備',
        titleEn: 'Preparation of Equipment',
        content:
