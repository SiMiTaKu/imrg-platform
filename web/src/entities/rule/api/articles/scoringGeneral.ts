    ...
    section: [
      {
        title: {
          japanese: '採点規則の適用',
          english: 'Application of the Code of Points',
        },
        content: {
          japanese: `
...
3. 審判員は、本規則を厳守しなければならない。厳守しない審判員は審判長によって改心されることがある。`,
          english: `1. The Code of Points is used to judge international and national competitions by common standards and to make their evaluation objective.
    ...
    section: [
      {
        title: {
          japanese: '競技と審判',
          english: 'Competition and Judging',
        },
        content: {
          japanese: `1. 新体操は判定競技であるから、審判員によって方向性と指導性とが決まるので、その責任は極めて重大である。
...
7. 不正または誤った判定は、指導者および競技者に大きな影響を与えるばかりでなく、新体操の普及にも支障をきたす。`,
          english: `1. Rhythmic gymnastics is a judged sport, so the judges set its direction and guide its development. Their responsibility is therefore very great.
...
7. Unfair or wrong judgments not only greatly affect coaches and gymnasts but also hinder the spread of rhythmic gymnastics.`,
      ...
      },
      {
        title: {
          japanese: '審判員規定',
          english: 'Regulations for Judges',
        },
        content: {
          japanese: `1. 本協会の監督下に開催される競技会では、公認審判認定規定に基づき資格を有した審判員が審判業務を行う。
...
9. 審判員は、定められた服装を着用し業務を行う。
  ...
  d. ネクタイ
  e. 審判バッヂ`,
          english: `1. At competitions held under the supervision of the Association, judging is done by judges certified under the regulations for certified judges.
...
9. Judges carry out their duties in the prescribed attire.
  ...
  e. Judge's badge`,
      ...
      },
      {
        title: {
          japanese: '審判研修会と審判会議',
          english: "Judges' Training Sessions and Judges' Meetings",
        },
        content: {
          japanese: `1. 審判会議および審判研修会では、規定演技のついては公式解説文または公式映像を参考にし、自由演技については、演技の構成・実施の良否を十分に審議し、採点の焦点を明らかにしなければならない。
2. 審判会議で能力不十分と認められた審判員は競技会から除名されることがある。`,
          english: `1. At the judges' meeting and training session, compulsory routines are reviewed with the official written explanation or the official video, and free routines are reviewed thoroughly for the quality of composition and execution, so that the focus of scoring is made clear.
...
"As a judge, I promise to act only in the spirit of sporting dignity and integrity, and to judge the routines performed conscientiously, without regard to the person or the organization."`,
      ...
      },
      {
        title: {
          japanese: '審判団の構成',
          english: 'Composition of the Judging Panel',
        },
        content: {
          japanese: `1. 競技会の審判団は原則として男子で編成する。
...
3. 予選競技と決勝競技か行われる競技会では、種目ならびに構成と実施を入れ替えて審判する。`,
          english: `1. As a rule, the judging panel of a competition consists of men.
...
3. At competitions with a qualification and a final, the judges switch events and switch between composition and execution.`,
      ...
      },
      {
        title: {
          japanese: '上級審判員',
          english: 'Superior Jury',
        },
        content: {
          japanese: `上級審判員は上級審判部内規に基づき以下の職務にあたる。
...
4. 警告の不満足な結果の後、審判人員を排除して交賛する事。`,
          english: `The Superior Jury carries out the following duties under its internal rules.
...
4. Removing and replacing judges if a warning does not lead to a satisfactory result.`,
      ...
      },
      {
        title: {
          japanese: '審判長',
          english: 'Jury President',
        },
        content: {
          japanese: `1. 審判長は男子新体操委員会で任命する。
...
4. 審判長は、競技会のあらゆる機会に審判員に干渉できる。正しく、かつ満足すべき方法で行動しない審判員に対しては、主任審判員の意見を聞いた上で、これを除名し交代させることができる。`,
          english: `1. The Jury President is appointed by the Men's Rhythmic Gymnastics Committee.
...
4. The Jury President may intervene with the judges at any time during the competition. After hearing the chief judge's opinion, the Jury President may remove and replace judges who do not act correctly and satisfactorily.`,
      ...
      },
      {
        title: {
          japanese: '主任審判員',
          english: 'Chief Judges',
        },
        content: {
          japanese: `1. 主任審判は、主任を務めるすべての演技を採点する。ただし主任審判員の採点は採点計算には加えられない。
...
5. 主任審判員が適用する減点があった場合は、これを有効点の平均から減点し最終得点を決定する。`,
          english: `1. The chief judge scores every routine on the panel they lead, but the chief judge's score is not included in the calculation.
...
5. If the chief judge applies a deduction, it is subtracted from the average of the counting scores to determine the final score.`,
      ...
      },
      {
        title: {
          japanese: '構成（Ｄ・Ａ）審判',
          english: 'Composition (D/A) Judges',
        },
        content: {
          japanese: '構成審判は実施された演技の構成的価値を判断し10点満点で採点する。',
          english:
      ...
      },
      {
        title: {
          japanese: '実施（Ｅ）審判',
          english: 'Execution (E) Judges',
        },
        content: {
          japanese: '実施審判は実施された演技の出来栄えを判断し10点満点で採点する。',
          english:
      ...
      },
      {
        ...
        content: {
          japanese: `計時審は以下の時間を計時し、構成主任審判員に報告する。

1. 入場から演技開始までの時間
2. 演技開始から演技終了までの時間`,
          english: `The timekeeper measures the following times and reports them to the composition chief judge.
...
2. The time from the start to the end of the routine`,
      ...
      },
      {
        title: {
          japanese: '補審',
          english: 'Reserve Judges',
        },
        content: {
          japanese: `補審は審判業務の補助を務める。また緊急の場合は審判交代に応じる。
...
2. 最低審判部は定款・競技規則、ルールとガイドラインの条件が守られているかも監視する。反則の場合には、最低審判部は処分に責任がある機関に報告する。`,
          english: `Reserve judges assist with the judging work and replace judges in an emergency.
...
2. The Appeals Jury also monitors whether the statutes, the competition rules, and the rules and guidelines are observed. In the case of a violation, it reports to the body responsible for sanctions.`,
  ...
  },
  {
    title: {
      japanese: '一般的な採点規則',
      english: 'General Scoring Rules',
    },
    section: [
      {
        title: {
          japanese: '採点方法と採点の開き',
          english: 'Scoring Method and Score Ranges',
        },
        content: {
          japanese: `1. 審判員は０点から10点までの各１点を20等分した点数で採点する。
...
5. 全審判員の採点最高点と最低点の開きは以下の点数より大きくてはならない。`,
          english: `1. Judges score from 0 to 10 points in steps of one twentieth of a point.
...
5. The range between the highest and lowest scores of all judges must not exceed the following.`,
        ...
        image: [
          {
            ...
            alt: {
              japanese: '有効点の開き',
              english: 'Allowed range of the counting scores',
            },
          },
          {
            ...
            alt: {
              japanese: '全審判員の点数の開き',
              english: "Allowed range of all judges' scores",
            },
          },
        ],
      },
      {
        ...
        content: {
          japanese: `基準点は、全審判員と主任審判員が集合して話し合っても問題が解決されない場合に適用される。計算は次のように行う。
（有効点の平均＋主任審判員の採点）／２＝基準点`,
          english: `The base score is used when the judges and the chief judge cannot resolve a problem even after discussing it together. It is calculated as follows.
(Average of the counting scores + chief judge's score) / 2 = base score`,
      ...
      },
      {
        ...
        content: {
          japanese: `1. 競技規則47条の時間に違反した場合は、長すぎても短すぎても減点とする。
【構成主任審判より原点：１秒につき・・・0.005点】

2. 演技時間が下記に満たなかった場合は得点を次の通りにする。
団体競技　２分３０秒　　　個人競技　１分００秒
【得点：構成・実施とも0．00点】`,
          english: `1. If the duration in Article 47 of the competition rules is not respected, a deduction is applied whether the routine is too long or too short.
...
[Score: 0.00 points for both composition and execution]`,
      ...
      },
      {
        title: {
          japanese: '演技開始までの時間',
          english: 'Time Before the Start of the Routine',
        },
        content: {
          japanese: `入場から演技開始までの時間が次の時間を超えた場合は減点とする。
団体競技・・・３０秒　　　個人競技・・・２０秒
【実施主任審判より減点・・・0．20点】`,
          english: `A deduction is applied if the time from entering the floor area to the start of the routine exceeds the following.
...
[Deduction by the execution chief judge: 0.20 points]`,
      ...
      },
      {
        title: {
          japanese: '演技面への入退場',
          english: 'Entering and Leaving the Floor Area',
        },
        content: {
          japanese: `演技面への入退場は、徒歩または駆け足で速やかに行わなければならない。
【違反した場合　実施審判より減点・・・0．20点】`,
          english: `Gymnasts must enter and leave the floor area promptly, walking or running.
[Violation: deduction by the execution judges, 0.20 points]`,
      ...
      },
      {
        ...
        content: {
          japanese: `場外の扱いは以下のとおりとし、実施主任審判より減点する。
...
【減点：身体または各手具１回につき・・・0．10点】`,
          english: `Out of bounds is treated as follows, and the deduction is applied by the execution chief judge.
...
[Deduction: 0.10 points each time for the body or for each apparatus]`,
      ...
      },
      {
        title: {
          japanese: '試合着',
          english: 'Competition Attire',
        },
        content: {
          japanese: `試合着に関する違反は以下のとおり減点する。
...
3. 著しく服装が乱れた場合。
【実施審判より減点：１名につき・・・0．10点】`,
          english: `Violations concerning competition attire are penalized as follows.
...
[Deduction by the execution judges: 0.10 points per gymnast]`,
      ...
      },
      {
        ...
        content: {
          japanese: `競技規則第45条に基づき、１から４の減点をする。
...
中断があった場合、審判長と競技部長は原因を速やかに確認し処理に当たる。`,
          english: `Under Article 45 of the competition rules, deductions 1 to 4 are applied.
...
If the music stops, the Jury President and the Competition Director promptly determine the cause and deal with it.`,
      ...
      },
      {
        ...
        content: {
          japanese: `1. 演技途中で手具が破損した場合、競技者は手部の差し替えをしなければならない。
...
8. 予備手具を使用した場合　【構成主任審判員より減点・・・0.50点】`,
          english: `1. If an apparatus breaks during the routine, the gymnast must replace it.
...
8. Use of a spare apparatus  [Deduction by the composition chief judge: 0.50 points]`,
      ...
      },
      {
        ...
        content: {
          japanese: `1. 競技者が競技規則第41条に違反した場合
【実施審判より減点：0．20点】

2. 監督者が競技規則第42条に違反した場合は厳重に注意をした上で減点や処分を決める。
【実施主任審判員より減点・・・0．20点】`,
          english: `1. A gymnast violates Article 41 of the competition rules.
