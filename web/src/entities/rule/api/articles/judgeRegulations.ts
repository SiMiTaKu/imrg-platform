...
export const JUDGE_REGULATIONS_ARTICLES: RuleArticle[] = [
  {
    title: {
      japanese: '公認審判員規則',
      english: 'Regulations for Certified Judges',
    },
    section: [
      {
        title: {
        ...
        content: {
          japanese: 'この規定は、公認審判員に関する事項について定める。',
          english: 'These regulations set out matters concerning certified judges.',
        },
      },
      {
        title: {
          japanese: '公認審判員の任務と区別',
          english: 'Duties and Categories of Certified Judges',
        },
        content: {
          japanese: `公認審判員は、体操競技、新体操の男子ならびに女子の４競技種別ごとに次の４種類とする。
...
6. （１）〜（３）の線審・計時審判については、いずれかの審判資格を有するものとする。`,
          english: `Certified judges are divided into the following four categories for each of the four disciplines: men's and women's artistic gymnastics and men's and women's rhythmic gymnastics.
...
6. Line judges and timekeepers must hold one of the qualifications in (1) to (3).`,
      ...
      },
      {
        title: {
          japanese: '認定の権限',
          english: 'Authority for Certification',
        },
        content: {
          japanese: `公認審判員の認定は次の通りにする。
...
2. 男子新体操委員会はこれらの業務遂行のため、専門委員若干名を選任するものとする。`,
          english: `Certified judges are certified as follows.
...
2. To carry out this work, the Men's Rhythmic Gymnastics Committee appoints a small number of expert members.`,
      ...
      },
      {
        title: {
          japanese: '受験・名誉資格',
          english: 'Eligibility and Honorary Status',
        },
        content: {
          japanese: `公認審判員の受験資格および名誉資格は次のとおりとする。
...
5. 国際審判員資格を取得する場合は、本会認定の１種資格を取得し、本会で推薦された者でなければならない。`,
          english: `Eligibility for the examination and for honorary status is as follows.
...
5. To obtain an international judge qualification, a person must hold Category 1 certified by the Association and be recommended by the Association.`,
      ...
      },
      {
        title: {
          japanese: '認定講習会',
          english: 'Certification Courses',
        },
        content: {
          japanese: `認定講習会の実施要項は次のとおりとする。
...
2. 認定講習会は、原則として最小限２日間として、次の内容とする。
  ...
  c. １種　講習会の講師は、本会の担当者２名以上でこれにあたる。講義と採点試験および理論試験を行う。`,
          english: `Certification courses are held as follows.
...
2. As a rule, a certification course lasts at least two days, with the following content.
  ...
  c. Category 1: the instructors are two or more people in charge from the Association, who give lectures, a scoring test and a theory test.`,
      ...
      },
      {
        ...
        content: {
          japanese: `FIGの改正期に併せて４年に一度を原則とする。中間年で、競技規則または採点規則に変更が生じた場合の伝達方法は次のとおりとする。
...
3. 研修会は、認定講習会を兼ねて行うこともできる。`,
          english: `As a rule, training sessions are held once every four years, in line with the FIG revision cycle. If the competition rules or the Code of Points change in the years in between, the changes are communicated as follows.
...
3. A training session may be held together with a certification course.`,
      ...
      },
      {
        title: {
          japanese: '資格の有効期間',
          english: 'Period of Validity',
        },
        content: {
          japanese: `資格の有効期間は次のとおりとする。
...
3. 名誉の有効期間は永年とする。`,
          english: `The period of validity of the qualification is as follows.
...
3. Honorary status does not expire.`,
      ...
      },
      {
        title: {
          japanese: '資格の継続',
          english: 'Renewal of the Qualification',
        },
        content: {
          japanese: `資格の継続については、次のとおりとする。
...
2. 継続申請をする者は、次の条件を満足していなければならない。
  ...
  c. 有効期間内における競技規則・採点規則の変更部分について精通すること。`,
          english: `Renewal of the qualification is as follows.
...
2. Applicants for renewal must meet the following conditions.
  ...
  c. They must be familiar with the changes to the competition rules and the Code of Points during the period of validity.`,
      ...
      },
      {
        title: {
          japanese: '資格の保留・取消',
          english: 'Suspension and Revocation of the Qualification',
        },
        content: {
          japanese: `資格の保留・取消の条件は次のとおりとする。
...
4. その他委員会が公認審判員として不適当と認めたときは、その資格を保留または取り消すことがある。`,
          english: `The conditions for suspending or revoking the qualification are as follows.
...
4. The qualification may also be suspended or revoked if the committee finds the person unsuitable as a certified judge.`,
      ...
      {
        title: {
          japanese: '認定・継続の申請手続き',
          english: 'Applying for Certification and Renewal',
        },
        content: {
          japanese: `認定および継続の申請は、次の要領で行うものとする。
...
4. 名誉の申請は、必要の都度行うこととし、特に期限は定めない。`,
          english: `Applications for certification and renewal are made as follows.
...
4. Applications for honorary status are made whenever needed, with no particular deadline.`,
      ...
      },
      {
        title: {
          japanese: '認定証の携行義務',
          english: 'Obligation to Carry the Certificate',
        },
        content: {
          japanese:
    ...
    section: [
      {
        title: {
          japanese: '付則',
          english: 'Supplementary Provisions',
        },
        content: {
          japanese: `1. 1種有効資格者で有効１年間に、役務上審判員としての実務ができなかった場合、競技役員としての含むを持って補充できるものとする。
...
平成18年2月18日 一部改定
平成19年2月24日 一部改定`,
          english: `1. If a holder of a valid Category 1 qualification could not judge during the one-year period of validity because of their duties, experience as a competition official may be counted instead.
