...
/**
 * 第3章 付録のうち、公認審判員規則。末尾の付則もこの規則の条項として持たせている。
...
4. मानद का आवेदन आवश्यकता पड़ने पर हर बार किया जाता है, और इसके लिए कोई विशेष समय सीमा निर्धारित नहीं है।`,
      ...
      // 付則は、冊子では公認審判員規則そのものの末尾に置かれている。
      // ほかの付録（2 登録規程 94ページ、3 競技者規程 96ページ）も同じく、
      // 規程の本文が終わったあとに附則が続く形になっている。
      // 出典: 公益財団法人日本体操協会『新体操男子規則 2025年版』5 付録
      {
        title: {
          ja: '付則',
