...
export const WORK_LIST: readonly BackgroundMusicWork[] = [
  {
    customerName: { ja: '佐藤綾人', en: 'Ayato Sato' },
    apparatus: 'rope',
    youtube: 'https://youtu.be/1qvuWxHhGx4',
  },
  {
    customerName: { ja: '佐藤颯人', en: 'Hayato Sato' },
    apparatus: 'rope',
  ...
  {
    customerName: { ja: '佐藤嘉人', en: 'Yoshito Sato' },
    apparatus: 'ring',
  ...
  {
    customerName: { ja: '満仲進哉', en: 'Shinya Manju' },
    apparatus: 'stick',
    youtube: 'https://youtu.be/GXRIiuiZkJc',
  },
  {
    customerName: { ja: '清水琢巳', en: 'Takumi Shimizu' },
    apparatus: 'ring',
  ...
  {
    customerName: { ja: '遠藤那央斗', en: 'Naoto Endo' },
    apparatus: 'ring',
    youtube: 'https://youtu.be/3uXmw1WxdEE',
  },
  {
    customerName: { ja: '田窪莉久', en: 'Riku Takubo' },
    apparatus: 'rope',
