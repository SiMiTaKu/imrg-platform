...
export const WORK_LIST: readonly BackgroundMusicWork[] = [
  {
    customerName: '佐藤綾人',
    customerNameEn: 'Ayato Sato',
    apparatus: 'rope',
    youtube: 'https://youtu.be/1qvuWxHhGx4',
  },
  {
    customerName: '佐藤颯人',
    customerNameEn: 'Hayato Sato',
    apparatus: 'rope',
  ...
  {
    customerName: '満仲進哉',
    customerNameEn: 'Shinya Manju',
    apparatus: 'stick',
    youtube: 'https://youtu.be/GXRIiuiZkJc',
  },
  {
    customerName: '清水琢巳',
    customerNameEn: 'Takumi Shimizu',
    apparatus: 'ring',
  ...
  {
    customerName: '遠藤那央斗',
    customerNameEn: 'Naoto Endo',
    apparatus: 'ring',
    youtube: 'https://youtu.be/3uXmw1WxdEE',
  },
  {
    customerName: '田窪莉久',
    customerNameEn: 'Riku Takubo',
    apparatus: 'rope',
