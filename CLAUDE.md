...
| [frontend-foundation.instructions.md](.github/instructions/frontend-foundation.instructions.md)                   | `web/src/` の実装                                     |
...
| [static-site-hosting.instructions.md](.github/instructions/static-site-hosting.instructions.md)                   | ページの追加、メタ情報・sitemap、本番への反映         |
